...
f_worksheet(wb,
  ...
  tables = list(
    list(
      data = table_3.1aa_data,
      title = paste0("Table 3.1aa: Reasons for Trusting NISRA in ", current_year)
    )
  )
)
...
f_worksheet(wb,
  ...
  tables = list(
    list(
      data = table_3.1ab_data,
      title = paste0("Table 3.1ab: Reasons for Distrusting NISRA in ", current_year)
    )
  )
)
