...
saveWorkbook(wb,
             paste0(here(), "/outputs/PfG/significance outputs/significance output NI assembly ",year, ".xlsx"),
             overwrite = TRUE
)
openXL(paste0(here(), "/outputs/PfG/significance outputs/significance output NI assembly ",year, ".xlsx"))
...
saveWorkbook(wb,
  paste0(here(), "/outputs/PfG/significance outputs/significance output media ",year,".xlsx"),
  overwrite = TRUE
)

openXL(paste0(here(), "/outputs/PfG/significance outputs/significance output media ",year,".xlsx"))
